/**
  ******************************************************************************
  * @file    ft32f030x8_comp.h
  * @author  AE
  * @version V1.0.0
  * @date    2020-06-22
  * @brief   This file contains all the functions prototypes for the COMP firmware 
  *          library, applicable only for FT32F030 devices.
  */

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __FT32F030X8_COMP_H
#define __FT32F030X8_COMP_H
...
#define	NCOMP_POL_INVERT					((uint32_t)0x00000001)
