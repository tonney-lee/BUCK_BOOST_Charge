/**
  ******************************************************************************
  * @file    FT32F072X8_eval_i2c_tsensor.c
  * @author  MCD Application Team
  * @version V1.0.0
  * @date    16-January-2014
  * @brief   This file provides a set of functions needed to manage the I2C LM75 
  *          temperature sensor mounted on FT32F072X8-EVAL board.
  ...
  *          performed in LM75_LowLevel_Init() function declared in FT32F072X8_eval.c 
  *          file.
...
/* Includes ------------------------------------------------------------------*/
#include "FT32F072X8_eval_i2c_tsensor.h"
...
/** @defgroup FT32F072X8_EVAL_I2C_TSENSOR_Private_Functions
  * @{
  */ 
