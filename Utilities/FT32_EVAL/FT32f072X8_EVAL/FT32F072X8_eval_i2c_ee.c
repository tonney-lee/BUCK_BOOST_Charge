/**
  ...
  *          from/to this memory. The needed FT32F0xx hardware resources (I2C and 
  *          GPIO) are defined in FT32F072X8_eval.h file, and the initialization is 
  *          performed in sEE_LowLevel_Init() function declared in FT32F072X8_eval.c 
  *          file.
...
/** @addtogroup FT32F072X8_EVAL_I2C_EE
  * @brief      This file includes the I2C EEPROM driver of FT32F072X8-EVAL board.
  * @{
  */ 
...
/** @defgroup FT32F072X8_EVAL_I2C_EE_Private_Functions
  * @{
  */ 
...
uint32_t sEE_WaitEepromStandbyState(void)      
{
  ...
  in FT32F072X8_eval_i2c_ee.h file) */
