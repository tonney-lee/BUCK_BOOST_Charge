...
/** @defgroup FT32F030XX_EVAL_LOW_LEVEL 
  * @brief This file provides firmware functions to manage Leds, push-buttons, 
  *        COM ports, SD card on SPI and temperature sensor (LM75) available on 
  *        FT32F030XX-EVAL evaluation board from FMD.
  * @{
...
/** @defgroup FT32F030XX_EVAL_LOW_LEVEL_Private_Functions
  * @{
  */ 
...
{
  /* There is no Wakeup button on FT32F030XX-EVAL. */
