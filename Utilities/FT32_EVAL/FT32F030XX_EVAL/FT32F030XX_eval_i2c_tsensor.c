/**
  ******************************************************************************
  * @file    FT32F030XX_eval_i2c_tsensor.c
  * @author  MCD Application Team
  * @version V1.1.1
  * @date    16-January-2014
  * @brief   This file provides a set of functions needed to manage the I2C LM75 
  *          temperature sensor mounted on FT32F030XX-EVAL board.
  *          It implements a high level communication layer for read and write 
  *          from/to this sensor. The needed FT32f0xx hardware resources (I2C and 
  *          GPIO) are defined in FT32F030XX_eval.h file, and the initialization is 
  *          performed in LM75_LowLevel_Init() function declared in FT32F030XX_eval.c 
  *          file.
...
/* Includes ------------------------------------------------------------------*/
#include "FT32F030XX_eval_i2c_tsensor.h"
...
/** @defgroup FT32F030XX_EVAL_I2C_TSENSOR_Private_Functions
  * @{
  */ 
