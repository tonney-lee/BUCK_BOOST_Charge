/**
  ******************************************************************************
  * @file    FT32F030XX_eval_spi_sd.c
  * @author  MCD Application Team
  * @version V1.1.1
  * @date    16-January-2014
  * @brief   This file provides a set of functions needed to manage the SPI SD 
  *          Card memory mounted on FT32F030XX-EVAL board.
  *          It implements a high level communication layer for read and write 
  *          from/to this memory. The needed FT32f0xx hardware resources (SPI and 
  *          GPIO) are defined in FT32F030XX_eval.h file, and the initialization is 
  *          performed in SD_LowLevel_Init() function declared in FT32F030XX_eval.c 
  *          file.
...
/** @addtogroup FT32F030XX_EVAL_SPI_SD
  * @brief      This file includes the SD card driver of FT32F030XX-EVAL boards.
  * @{
  */ 
...
/** @defgroup FT32F030XX_EVAL_SPI_SD_Private_Variables
  * @{
  */ 
...
/** @defgroup FT32F030XX_EVAL_SPI_SD_Private_Function_Prototypes
  * @{
  */
/**
  * @}
...
/** @defgroup FT32F030XX_EVAL_SPI_SD_Private_Functions
  * @{
  */ 
