/**
  ******************************************************************************
  * @file    FT32F030XX_eval.h
  * @author  MCD Application Team
  * @version V1.1.1
  * @date    16-January-2014
  * @brief   This file contains definitions for FT32F030XX_EVAL's Leds, push-buttons
...
#ifndef __FT32F030XX_EVAL_H
#define __FT32F030XX_EVAL_H
...
/** @addtogroup FT32F030XX_EVAL
  * @{
  */
      
/** @addtogroup FT32F030XX_EVAL_LOW_LEVEL
  * @{
  */ 
...
/** @defgroup FT32F030XX_EVAL_LOW_LEVEL_Exported_Constants
  * @{
  */ 

/** 
  * @brief  Define for FT32F030XX_EVAL board  
  */ 
#if !defined (USE_FT32F030XX_EVAL)
/* #define USE_FT32F030XX_EVAL*/
#endif

/**
 * @brief Select the revision A or B(default) of the EVAL board used.  
 */
#if !defined (FT32F030XX_EVAL_REVB)
 #define FT32F030XX_EVAL_REVB
#endif

#if !defined (FT32F030XX_EVAL_REVA)
 /* #define FT32F030XX_EVAL_REVA */
#endif


/** @addtogroup FT32F030XX_EVAL_LOW_LEVEL_LED
  * @{
  */
#define LEDn                             4
...
/** @addtogroup FT32F030XX_EVAL_LOW_LEVEL_BUTTON
  * @{
  */  
#define BUTTONn                          7
...
/** @addtogroup FT32F030XX_EVAL_LOW_LEVEL_COM
  * @{
  */
#define COMn                             1
...
/** @addtogroup FT32F030XX_EVAL_LOW_LEVEL_SD_SPI
  * @{
  */
/**
...
#elif defined (FT32F030XX_EVAL_REVB)
...
#define SD_CS_PIN                        GPIO_Pin_15                  /* PA.15 */
...
/** @addtogroup FT32F030XX_EVAL_LOW_LEVEL_TSENSOR_I2C
  * @{
  */
/**
...
/** @addtogroup FT32F030XX_EVAL_LOW_LEVEL_I2C_EE
  * @{
  */
/**
...
/** @defgroup FT32F030XX_EVAL_LOW_LEVEL_Exported_Functions
  * @{
  */
