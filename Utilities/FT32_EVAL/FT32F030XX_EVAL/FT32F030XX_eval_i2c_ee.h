/**
  ******************************************************************************
  * @file    FT32F030XX_eval_i2c_ee.h
  * @author  MCD Application Team
  * @version V1.1.1
  * @date    16-January-2014
  * @brief   This file contains all the functions prototypes for 
  *          the FT32F030XX_eval_i2c_ee.c firmware driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef __FT32F030XX_EVAL_I2C_EE_H
#define __FT32F030XX_EVAL_I2C_EE_H
...
/** @addtogroup FT32F030XX_EVAL_I2C_EE
  * @{
  */  

/** @defgroup FT32F030XX_EVAL_I2C_EE_Exported_Types
  * @{
  */ 
...
/** @defgroup FT32F030XX_EVAL_I2C_EE_Exported_Constants
  * @{
  */
...
/* Uncomment the following line to use the default sEE_TIMEOUT_UserCallback() 
   function implemented in FT32F030XX_eval_i2c_ee.c file.
...
/* IN sEE_LowLevel_Init(),  the I2C CLK is set to  RCC_I2C1CLK_SYSCLK */
//#define sEE_I2C_TIMING         0x10210507// 0x00210507	//when =HSI
#define sEE_I2C_TIMING         0xF0210507	//when =SYSCLK=48MHZ
...
extern __IO uint16_t  sEEAddress;   
...
/** @defgroup FT32F030XX_EVAL_I2C_EE_Exported_Macros
  * @{
  */    
/**
  * @}
...
/** @defgroup FT32F030XX_EVAL_I2C_EE_Exported_Functions
  * @{
  */ 
...
/* sEE_TIMEOUT_UserCallback() function is called whenever a timeout condition 
   ...
   define USE_DEFAULT_TIMEOUT_CALLBACK in FT32F030XX_eval_i2c_ee.h file.
...
#endif /* __FT32F030XX_EVAL_I2C_EE_H */
/**
  * @}
  */
