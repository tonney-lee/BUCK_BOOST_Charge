...
/** @defgroup FT32F030XX_EVAL_LCD_Private_Functions
  * @{
  */ 
...
/**
  ...
  *         mounted on FT32F030XX-EVAL board, however user can tailor it according
