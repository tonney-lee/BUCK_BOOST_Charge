/**
  ******************************************************************************
  * @file    FT32_eval_legacy.h
  * @author  MCD Application Team
  * @version V5.0.2
  * @date    05-March-2012
  * @brief   This file contains defines legacy for FT32 EVAL drivers.
  ******************************************************************************
  * @attention
  *
  * <h2><center>&copy; COPYRIGHT 2012 FTicroelectronics</center></h2>
  *
...
#ifndef __FT32_EVAL_LEGACY_H
#define __FT32_EVAL_LEGACY_H
...
/* Exported types ------------------------------------------------------------*/
/* Exported constants --------------------------------------------------------*/
/* FT322xG_EVAL Defines Legacy */ 
#ifdef USE_FT3220F_EVAL       
  #define USE_FT322xG_EVAL
#endif
#define FT3220F_LCD_Init       FT322xG_LCD_Init
