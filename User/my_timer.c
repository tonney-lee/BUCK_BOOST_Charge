 ...
 * @retval None
 */
//#define MCU_CLOCK (48)     // (MHz) ��Ƶ
#define PWM_FREQUENCY (250) // (kHz) �ز�Ƶ��
#define Pole_Pairs (5)      // ������

/*TIM1�Ĳ�������*/
#define TIM1_Prescaler 0 //Ԥ��ƵΪ0
...
#define TIM1_PWM_PERIOD (TIM1_PWM_MAX_PULSE - 1) //��ʼռ�ձ�
...
static void TIM1_Config(void)
{
    ...
    TIM_OCInitStructure.TIM_OCPolarity = TIM_OCPolarity_High;  // CHx�������?:TIM����Ƚϼ��Ը�?(PWM����ĵ�ƽ����?)
    TIM_OCInitStructure.TIM_OCIdleState = TIM_OCIdleState_Set; // CHx�������״�?:0
    TIM_OCInitStructure.TIM_Pulse = TIM1_InitDuty;             //��ʼ����
